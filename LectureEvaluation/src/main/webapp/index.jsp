...
<body>
	...
	<!-- 반응형을 위한 container. get방식으로 서버에 전달 -->
	<section class="container">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">인간지능 개론&nbsp;<small>Alan Touring</small></div>
			...
			<div class="card-body">
				...
				<p class="card-text">강의가 많이 널널해서, 솔직히 많이 배운건 없는 것 같지만 학점도 잘 나오고 너무 좋았습니다!</p>
				<div class="row">
			...
			<div class="modal-content">
				<div class="modal-header">
	 			...
	 			<div class="modal-body">
	 				<form action="./evalutaionRegisterAction.jsp" method="post">
		 				...
		 				<div class ="form-group">
	 						...
	 						<div class="form-row">
		 						...
		 						<div class="form-group col-sm-3">
		 							<label>난이도</label>
			 							<select name="levelScore" class="form-control">
			 								<option value="A" selected>A</option>
										    <option value="B" selected>B</option>
										    <option value="C" selected>C</option>
										    <option value="D" selected>D</option>
